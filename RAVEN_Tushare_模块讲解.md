...
| 股票池 | HS300 |
| 数据频率 | 日频 |
| 数据区间 | 2009-01-01 至 2024-12-31 |
| 训练集 | 2009-01-01 至 2019-12-31 |
...
~~~python
TUSHARE_TOKEN = "你的真实Tushare Token"
~~~
...
如果使用环境变量，也可以在系统中设置 TUSHARE_TOKEN，但为了方便第一次使用，建议直接改文件顶部的 Token。
...
~~~text
训练：2009-01-01 至 2019-12-31
测试：2020-01-01 至 2024-12-31
~~~

脚本默认不使用测试集调参。

如果你希望更严格地使用验证集，可以在 Config 中设置：
...
正式研究时，建议使用你习惯的 rolling / walk-forward 方式，而不是只做一次固定切分。
